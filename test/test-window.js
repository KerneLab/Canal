...
QUnit.test("window() ntile(4)", function(assert)
{
	var result = Canal.of(dataSource).select()
	.window(
		Canal.wf.ntile(4)
...
QUnit.test("window() ntile(3)", function(assert)
{
	var result = Canal.of(dataSource).select()
	.window(
		Canal.wf.ntile(3)
...
QUnit.test("window() lag()", function(assert)
{
	var result = Canal.of(dataSource).select()
	.window(
...
QUnit.test("window() lead()", function(assert)
{
	var result = Canal.of(dataSource).select()
	.window(
...
QUnit.test("window() cume_dist()", function(assert)
{
	var result = Canal.of(dataSource).select()
	.window(
		Canal.wf.cume_dist()
